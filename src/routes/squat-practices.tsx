  ...
  head: () => ({
    meta: [
      { title: "Squat Practices — CQC registration & compliance from day one — SDC&T" },
      {
        name: "description",
        content:
          "Opening a new dental clinic? We handle CQC registration, policies, RPA and full compliance setup so you can open your doors compliant — and help you appeal if rejected.",
      },
    ...
    <SiteLayout>
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 text-white sm:px-6 lg:px-8 lg:py-32">
          ...
          <h1 className="mt-5 max-w-4xl text-4xl font-extrabold sm:text-5xl lg:text-6xl">
            Opening a squat practice? We'll get you CQC-registered and compliant from day one.
          </h1>
          <p className="mt-5 max-w-2xl text-lg text-white/90">
            Setting up a brand-new dental clinic is daunting — we handle the compliance so you can
            focus on opening your doors.
          </p>
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl text-center">
          <SectionHeading
            ...
            title="Building a new dental clinic from the ground up?"
            description="A squat practice is a brand-new clinic, set up from scratch. We specialise in helping first-time owners and seasoned principals get everything in place — properly, the first time."
            center
          />
        </div>
      </section>
      ...
      <section className="bg-surface px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-6xl items-start gap-12 lg:grid-cols-2">
          <div>
            <SectionHeading
              eyebrow="CQC registration"
              title="We guide you through the entire process"
          ...
          <div className="rounded-3xl border border-border bg-background p-6 shadow-soft">
            ...
            <ul className="mt-4 space-y-3">
              {[
                "CQC application & supporting evidence",
                "Registered Manager support",
                "Statement of Purpose",
                "Full policies & procedures pack",
                "RPA appointment & service",
                "Fire, Legionella, H&S, Disability risk assessments",
              ].map((t) => (
                <li key={t} className="flex items-start gap-3 text-sm">
                  <span className="mt-0.5 grid h-5 w-5 place-items-center rounded-full gradient-teal-purple text-white">
          ...
          <div className="grid items-center gap-8 lg:grid-cols-[auto_1fr_auto]">
            ...
            <div>
              <h2 className="text-2xl font-extrabold sm:text-3xl">
                CQC application rejected? Don't panic — we can help you turn it around.
              </h2>
              <p className="mt-2 text-white/90">
                We'll review the reasons for rejection, fix the shortfalls, and help you appeal or
                re-apply so you get registered.
              </p>
            </div>
            <Button
              asChild
      ...
      <section className="bg-surface px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionHeading
            eyebrow="Squat setup"
            title="What a new practice needs — and how we deliver it"
            center
          />
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl text-center">
          <SectionHeading
            ...
            title="Everything under one roof, from day one"
            description="Dental-specific expertise, a single point of contact, and ongoing support after you open via our Smart Managed Service."
            center
          />
        </div>
      </section>
      ...
      <VideoReviews />
      <CTASection
        title="Book your free squat practice consultation"
        subtitle="A 30-minute call to map out exactly what your new clinic needs."
      />
    </SiteLayout>
  );
}
