...
const FileCheckCorner = createLucideIcon("file-check-corner", __iconNode$k);
const __iconNode$j = [
  [
    "path",
    {
...
const FolderHeart = createLucideIcon("folder-heart", __iconNode$i);
const __iconNode$h = [
  [
    "path",
    {
...
const HeartHandshake = createLucideIcon("heart-handshake", __iconNode$g);
const __iconNode$f = [
