...
function ResourcesPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-surface px-4 py-16 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { title: "Compliance logbooks", description: "Practical, role-specific logbooks - GBP 49.99 each." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-4", children: logbooks.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-3xl border border-border bg-background shadow-soft", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => toast.success(`${b.name} added - checkout opens on the next step`), className: "mt-4 w-full rounded-full gradient-purple-orange text-white", children: "Buy" })
        ] })
      ] }, b.id)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 py-16 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl", children: [
      ...
      PAID_RESOURCES.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 rounded-3xl border border-dashed border-border bg-muted/40 p-10 text-center text-muted-foreground", children: "More paid resources coming soon." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 grid gap-5 lg:grid-cols-3", children: PAID_RESOURCES.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl border border-border bg-background p-6 shadow-soft", children: [
