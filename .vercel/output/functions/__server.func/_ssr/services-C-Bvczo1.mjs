...
const SERVICE_BOOKING_MAP = {
  "mock-inspection": "mock-inspection",
  "due-diligence": "due-diligence",
  managed: "managed-service",
  "new-practice": "new-practice-setup",
  "cqc-registration": "other"
};
const SERVICES = [{
  id: "mock-inspection",
  icon: ClipboardCheck,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 py-20 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl space-y-6", children: [
      SERVICES.map(({
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, className: "rounded-full gradient-purple-orange text-white lg:self-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/book", search: {
          service: SERVICE_BOOKING_MAP[id]
        }, children: [
          cta,
          " ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 rounded-3xl gradient-blue-teal p-8 text-center text-white sm:p-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 flex flex-wrap justify-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "outline", className: "rounded-full border-2 border-white bg-transparent text-white hover:bg-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/book", search: {
            service: "other"
