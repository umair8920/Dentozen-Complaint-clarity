...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ypGOFKzi.mjs");
...
const manifest = {
  "51496c6ca2b5055341948a46205d4083f7301883d1e1b16d00d2abd04c02d91c": {
    ...
    importer: () => import("./contact.functions-3uJ7N3Ar.mjs")
  },
  "bf20422b8d4d52c0bf2cfb138cd71deb959abbfacab80465d4c17a5819b4e4f2": {
    functionName: "submitPackageQuote_createServerFn_handler",
    importer: () => import("./package.functions-DWPRV5I1.mjs")
  },
  "f772fefa96478c6a8f9bf5816d29d6b432d9650f9f42958d1ff9b17bdfc3422b": {
    functionName: "submitBookingForm_createServerFn_handler",
    importer: () => import("./booking.functions-I00wPAnD.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DxHWs9qb.mjs").then((n) => n.r),
    import("./start-zfZsHqu9.mjs"),
