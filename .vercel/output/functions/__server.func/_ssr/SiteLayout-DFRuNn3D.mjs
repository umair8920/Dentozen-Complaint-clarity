...
const desktopLinkClass = "rounded-full px-3 py-2 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground";
const desktopActiveLinkClass = "rounded-full px-3 py-2 text-sm font-semibold text-foreground bg-muted";
const desktopPricingLinkClass = "inline-flex items-center rounded-full px-3 py-2 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground";
const desktopPricingActiveLinkClass = "inline-flex items-center rounded-full px-3 py-2 text-sm font-semibold text-foreground bg-muted";
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 border-b border-border/60 bg-background/80 backdrop-blur-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden items-center gap-1 xl:flex", children: [
        DESKTOP_NAV.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: item.to,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                "Pricing",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 text-xs transition-transform group-hover:-translate-y-px", children: "^" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "invisible absolute left-1/2 top-full z-50 -translate-x-1/2 pt-3 opacity-0 transition duration-150 group-hover:visible group-hover:opacity-100 group-focus-within:visible group-focus-within:opacity-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-[280px] rounded-2xl border bg-popover p-3 text-popover-foreground shadow-xl", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-2 left-1/2 h-4 w-4 -translate-x-1/2 rotate-45 border-l border-t bg-popover" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: PRICING_MENU.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: item.to,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden items-center gap-2 lg:flex", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/book", children: "Book Now" })
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            onClick: () => setOpen(false),
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/build-your-package", children: "Build Package" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
