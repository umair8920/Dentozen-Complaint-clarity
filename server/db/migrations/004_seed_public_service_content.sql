...
where section in ('services', 'pricing', 'build-your-package', 'packages');

insert into admin_service_items
  (section, content_key, title, description, price, status, display_order, metadata)
values
  ('services', 'mock-inspection', 'CQC Mock Inspections', 'A full mock inspection just before your CQC inspection, with a detailed report and help implementing every action plan - so you walk into the real thing ready and confident.', null, 'active', 10, '{"itemId":"mock-inspection","icon":"ClipboardCheck","gradient":"gradient-teal-purple","cta":"Book a mock inspection","bookingService":"mock-inspection"}'),
  ('services', 'due-diligence', 'Due Diligence Mock Inspection', 'Buying a dental practice? We carry out a full compliance due diligence review before you purchase - so you know exactly what you are buying and what it takes to make it compliant.', null, 'active', 20, '{"itemId":"due-diligence","icon":"Building2","gradient":"gradient-purple-orange","cta":"Enquire about due diligence","bookingService":"due-diligence"}'),
  ('services', 'managed', 'Smart Managed Service', 'We take over your compliance entirely. Quarterly visits to keep policies, procedures and every certificate up to date. Bundle every service with one provider - nothing gets misplaced. Your fully managed compliance partner.', null, 'active', 30, '{"itemId":"managed","icon":"Sparkles","gradient":"gradient-orange-gold","cta":"Enquire about managed service","badge":"Fully managed \u00b7 subscription","bookingService":"managed-service"}'),
  ('services', 'new-practice', 'Compliance Setup for New Practices', 'Opening a new dental practice? We get you compliant from day one - CQC registration, policies and procedures, RPA service, risk assessments, the lot.', null, 'active', 40, '{"itemId":"new-practice","icon":"Stethoscope","gradient":"gradient-blue-teal","cta":"Set up my new practice","bookingService":"new-practice-setup"}'),
  ('services', 'cqc-registration', 'CQC Registration Service', 'Standalone CQC registration support for new practices and for practices going through ownership or structural changes.', null, 'active', 50, '{"itemId":"cqc-registration","icon":"FileCheck2","gradient":"gradient-teal-purple","cta":"Start CQC registration","bookingService":"other"}'),

  ('packages', 'pkg-essential', 'Essential Compliance Package', 'Meet your fundamental safety and compliance requirements.', 199, 'active', 10, '{"itemId":"pkg-essential","tagline":"Meet your fundamental safety and compliance requirements.","gradient":"gradient-blue-teal","popular":false,"features":["Fire, Legionella, Health & Safety, Disability Risk Assessments","PAT Testing","Emergency Lighting","Fire Extinguisher Service","Autoclave PVI Testing","Compressor PVI Testing"]}'),
  ('packages', 'pkg-safety', 'Safety & Training Package', 'Prioritise staff training and equipment safety.', 299, 'active', 20, '{"itemId":"pkg-safety","tagline":"Prioritise staff training and equipment safety.","gradient":"gradient-teal-purple","popular":true,"features":["Fire, Legionella, Health & Safety, Disability Risk Assessments","PAT Testing","Emergency Lighting","Fire Extinguisher Service","Autoclave PVI Testing","Compressor PVI Testing","Cross Infection Training","Medical Emergency & BLS Training"]}'),
  ('packages', 'pkg-complete', 'Complete Compliance & Safety Package', 'Our full-service solution for total workplace safety.', 399, 'active', 30, '{"itemId":"pkg-complete","tagline":"Our full-service solution for total workplace safety.","gradient":"gradient-purple-orange","popular":false,"features":["Fire, Legionella, Health & Safety, Disability Risk Assessments","PAT Testing","Emergency Lighting","Fire Extinguisher Service","Autoclave PVI Testing","Compressor PVI Testing","RPA Service","Annual Mock Inspection"]}'),
